...
namespace Router\Points\Infrastructure\Services;
...
use Router\Points\Contracts\DTOs\GeocodeDTO;
...
class GoogleMaps
{
     ...
     * @throws Exception
     */
    public function geocode(string $fullAddress): GeocodeDTO
    {
    ...
    private function parseGecodeResponse(Response $response): GeocodeDTO
    {
        if ($response->failed()) {
